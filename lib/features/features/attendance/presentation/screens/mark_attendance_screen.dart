...
class _MarkAttendanceScreenState extends ConsumerState<MarkAttendanceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Load students filtered by this class/section
    ref.listen(studentFilterProvider, (_, __) {});
              ...
              return Padding(
                ...
                child: SizedBox(
                  ...
                  child: DropdownButtonFormField<String>(
                    decoration: const InputDecoration(labelText: 'Subject (optional, daily attendance ke liye khali chhoden)'),
          ...
          Expanded(
            child: studentsAsync.when(
              data: (result) {
                ...
                // Load existing attendance once (edit mode detection)
                  ...
                  children: [
                    if (isLocked)
                      Container(
                        ...
                        child: const Text(
                          'Ye attendance ka edit-window (24 ghante) khatam ho chuka hai. Admin se rabta karein.',
