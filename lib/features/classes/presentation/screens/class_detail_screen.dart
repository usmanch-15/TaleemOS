            ...
            data: (sections) => ListView(
              children: sections
                ...
                trailing: IconButton(
                  ...
                  onPressed: () =>
                      ref.read(classManagementControllerProvider.notifier).deleteSection(s.id, widget.classId),
                ),
              ))
                  .toList(),
            ),
            ...
            data: (subjects) => ListView(
              children: subjects
                ...
                trailing: IconButton(
                  icon: const Icon(Icons.delete_outline, color: Colors.red),
                  onPressed: () =>
                      ref.read(classManagementControllerProvider.notifier).deleteSubject(s.id, widget.classId),
                ),
              ))
                  .toList(),
            ),
